...
from rescue_moto.core import ACCOUNT_ID as DEFAULT_ACCOUNT_ID
...
class Statistics:
    ...
    def average(self):
        ...
        # when rescue_moto is 3.4+ we can switch to the statistics module

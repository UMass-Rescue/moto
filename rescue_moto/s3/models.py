...
from rescue_moto.core import ACCOUNT_ID, BaseBackend, BaseModel, CloudFormationModel
from rescue_moto.core.utils import iso_8601_datetime_without_milliseconds_s3, rfc_1123_datetime
from rescue_moto.cloudwatch.models import MetricDatum
from rescue_moto.utilities.tagging_service import TaggingService
...
class FakeKey(BaseModel):
    ...
    def value(self, new_value):
        ...
        # Hack for working around rescue_moto's own unit tests; this probably won't
...
class FakeBucket(CloudFormationModel):
    ...
    def set_logging(self, logging_config, bucket_backend):
        ...
        # Target bucket must exist in the same account (assuming all rescue_moto buckets are in the same account):
...
class S3Backend(BaseBackend):
    ...
    def get_account_public_access_block(self, account_id):
        # The account ID should equal the account id that is set for rescue_moto:

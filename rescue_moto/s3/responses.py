...
from rescue_moto.core.utils import (
...
from rescue_moto.packages.httpretty.core import HTTPrettyRequest
from rescue_moto.core.responses import _TemplateEnvironmentMixin, ActionAuthenticatorMixin
from rescue_moto.core.utils import path_url
from rescue_moto.core import ACCOUNT_ID
from rescue_moto.settings import S3_IGNORE_SUBDOMAIN_BUCKETNAME

from rescue_moto.s3bucket_path.utils import (
...
def is_delete_keys(request, path, bucket_name):
    ...
    # https://github.com/spulec/rescue_moto/issues/2937
    return (
        path == "/?delete"
        or path == "/?delete="

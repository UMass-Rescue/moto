...
TODO add support and create tests for all services in rescue_moto (for example, API Gateway is probably not supported currently)
...
from rescue_moto.core.exceptions import (
    SignatureDoesNotMatchError,
    AccessDeniedError,
    InvalidClientTokenIdError,
    AuthFailureError,
)
from rescue_moto.s3.exceptions import (
...
from rescue_moto.sts import sts_backend

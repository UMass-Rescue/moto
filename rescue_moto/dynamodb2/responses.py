...
from rescue_moto.core.responses import BaseResponse
from rescue_moto.core.utils import camelcase_to_underscores, amz_crc32, amzn_request_id
from .exceptions import (
    InvalidIndexNameError,
    MockValidationException,
    TransactionCanceledException,
)
from rescue_moto.dynamodb2.models import dynamodb_backends, dynamo_json_dump
...
class DynamoHandler(BaseResponse):
    ...
    def dynamodb_backend(self):
        ...
        :rtype: rescue_moto.dynamodb2.models.DynamoDBBackend
        """

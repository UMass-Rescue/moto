...
from rescue_moto.compat import OrderedDict
from rescue_moto.core import ACCOUNT_ID
from rescue_moto.core import BaseBackend, BaseModel, CloudFormationModel
from rescue_moto.core.utils import unix_time, unix_time_millis
from rescue_moto.core.exceptions import JsonRESTError
from rescue_moto.dynamodb2.comparisons import get_filter_expression
from rescue_moto.dynamodb2.comparisons import get_expected
from rescue_moto.dynamodb2.exceptions import (
...
from rescue_moto.dynamodb2.models.utilities import bytesize
from rescue_moto.dynamodb2.models.dynamo_type import DynamoType
from rescue_moto.dynamodb2.parsing.executors import UpdateExpressionExecutor
from rescue_moto.dynamodb2.parsing.expressions import UpdateExpressionParser
from rescue_moto.dynamodb2.parsing.validators import UpdateExpressionValidator
from rescue_moto.dynamodb2.limits import HASH_KEY_MAX_LENGTH, RANGE_KEY_MAX_LENGTH
...
# https://github.com/spulec/rescue_moto/issues/1874
...
class StreamShard(BaseModel):
    ...
    def add(self, old, new):
        ...
        result = None
        from rescue_moto.awslambda import lambda_backends
...
class Table(CloudFormationModel):
    ...
    def get_cfn_attribute(self, attribute_name):
        from rescue_moto.cloudformation.exceptions import UnformattedGetAttTemplateException

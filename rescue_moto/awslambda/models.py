...
from rescue_moto.awslambda.policy import Policy
from rescue_moto.core import BaseBackend, CloudFormationModel
from rescue_moto.core.exceptions import RESTError
from rescue_moto.iam.models import iam_backend
from rescue_moto.iam.exceptions import IAMNotFoundException
from rescue_moto.core.utils import unix_time_millis
from rescue_moto.s3.models import s3_backend
from rescue_moto.logs.models import logs_backends
from rescue_moto.s3.exceptions import MissingBucket, MissingKey
...
from rescue_moto.sqs import sqs_backends
from rescue_moto.dynamodb2 import dynamodb_backends2
from rescue_moto.dynamodbstreams import dynamodbstreams_backends
from rescue_moto.core import ACCOUNT_ID
from rescue_moto.utilities.docker_utilities import DockerModel, parse_image_ref
        ...
        try:
            ...
            with _DockerDataVolumeContext(self) as data_vol:
                try:
                    ...
                    run_kwargs = (
                        dict(links={"rescue_motoserver": "rescue_motoserver"})

...
from resqs.packages.httpretty.core import HTTPrettyRequest
from resqs.core.responses import _TemplateEnvironmentMixin, ActionAuthenticatorMixin
from resqs.core.utils import path_url
from resqs.core import ACCOUNT_ID
from resqs.settings import S3_IGNORE_SUBDOMAIN_BUCKETNAME

from resqs.s3bucket_path.utils import (
...
def is_delete_keys(request, path, bucket_name):
    ...
    # https://github.com/spulec/resqs/issues/2937
    return (
        path == "/?delete"
        or path == "/?delete="

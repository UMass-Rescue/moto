...
from resqs.awslambda.policy import Policy
from resqs.core import BaseBackend, CloudFormationModel
from resqs.core.exceptions import RESTError
from resqs.iam.models import iam_backend
from resqs.iam.exceptions import IAMNotFoundException
from resqs.core.utils import unix_time_millis
from resqs.s3.models import s3_backend
from resqs.logs.models import logs_backends
from resqs.s3.exceptions import MissingBucket, MissingKey
...
from resqs.sqs import sqs_backends
from resqs.dynamodb2 import dynamodb_backends2
from resqs.dynamodbstreams import dynamodbstreams_backends
from resqs.core import ACCOUNT_ID
from resqs.utilities.docker_utilities import DockerModel, parse_image_ref
        ...
        try:
            ...
            with _DockerDataVolumeContext(self) as data_vol:
                try:
                    ...
                    run_kwargs = (
                        dict(links={"resqsserver": "resqsserver"})

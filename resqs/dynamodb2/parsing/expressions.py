...
from resqs.dynamodb2.exceptions import InvalidTokenException, InvalidUpdateExpression
from resqs.dynamodb2.parsing.tokens import Token, ExpressionTokenizer
...
class NestableExpressionParserMixin(object):
    ...
    def _create_node(self):
        ...
        Returns:
            resqs.dynamodb2.ast_nodes.Node: Node of an AST representing the Expression as produced by the factory.
        """
...
class ExpressionParser:
    ...
    def _parse(self):
        ...
        Returns:
            resqs.dynamodb2.ast_nodes.Node: AST which is root node of resulting abstract syntax tree
        """
    ...
    def _is_possible_start(cls, token):
        ...
        Args:
            token(resqs.dynamodb2.tokens.Token):
    ...
    def get_next_token(self):
        ...
        Returns:
            resqs.dynamodb2.tokens.Token: or None if no more next token
        """
        try:

...
from resqs.compat import OrderedDict
from resqs.core import ACCOUNT_ID
from resqs.core import BaseBackend, BaseModel, CloudFormationModel
from resqs.core.utils import unix_time, unix_time_millis
from resqs.core.exceptions import JsonRESTError
from resqs.dynamodb2.comparisons import get_filter_expression
from resqs.dynamodb2.comparisons import get_expected
from resqs.dynamodb2.exceptions import (
...
from resqs.dynamodb2.models.utilities import bytesize
from resqs.dynamodb2.models.dynamo_type import DynamoType
from resqs.dynamodb2.parsing.executors import UpdateExpressionExecutor
from resqs.dynamodb2.parsing.expressions import UpdateExpressionParser
from resqs.dynamodb2.parsing.validators import UpdateExpressionValidator
from resqs.dynamodb2.limits import HASH_KEY_MAX_LENGTH, RANGE_KEY_MAX_LENGTH
...
# https://github.com/spulec/resqs/issues/1874
...
class StreamShard(BaseModel):
    ...
    def add(self, old, new):
        ...
        result = None
        from resqs.awslambda import lambda_backends
...
class Table(CloudFormationModel):
    ...
    def get_cfn_attribute(self, attribute_name):
        from resqs.cloudformation.exceptions import UnformattedGetAttTemplateException

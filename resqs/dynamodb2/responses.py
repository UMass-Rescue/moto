...
from resqs.core.responses import BaseResponse
from resqs.core.utils import camelcase_to_underscores, amz_crc32, amzn_request_id
from .exceptions import (
    InvalidIndexNameError,
    MockValidationException,
    TransactionCanceledException,
)
from resqs.dynamodb2.models import dynamodb_backends, dynamo_json_dump
...
class DynamoHandler(BaseResponse):
    ...
    def dynamodb_backend(self):
        ...
        :rtype: resqs.dynamodb2.models.DynamoDBBackend
        """

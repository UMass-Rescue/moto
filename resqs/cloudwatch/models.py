...
from resqs.core import ACCOUNT_ID as DEFAULT_ACCOUNT_ID
...
class Statistics:
    ...
    def average(self):
        ...
        # when resqs is 3.4+ we can switch to the statistics module

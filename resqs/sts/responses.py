...
from resqs.iam import iam_backend
...
class TokenResponse(BaseResponse):
    ...
    def get_caller_identity(self):
        ...
        # Default values in case the request does not use valid credentials generated by resqs
        user_id = "AKIAIOSFODNN7EXAMPLE"
        arn = "arn:aws:sts::{account_id}:user/resqs".format(account_id=ACCOUNT_ID)

...
TODO add support and create tests for all services in resqs (for example, API Gateway is probably not supported currently)
...
from resqs.core.exceptions import (
    SignatureDoesNotMatchError,
    AccessDeniedError,
    InvalidClientTokenIdError,
    AuthFailureError,
)
from resqs.s3.exceptions import (
...
from resqs.sts import sts_backend

import json
import boto3
from resqs.core.exceptions import InvalidNextTokenException
from resqs.core.models import ConfigQueryModel
from resqs.iam import iam_backends
...
class RoleConfigQuery(ConfigQueryModel):
    def list_config_service_resources(
        ...
        # Stored in resqs backend with the AWS-assigned random string like "AROA0BSVNSZKXVHS00SBJ"
        ...
        if aggregator:
            ...
            # we can't really tell if this has happened in resqs, we'll just bind this to the regions in your aggregator
            aggregated_regions = []
...
class PolicyConfigQuery(ConfigQueryModel):
    def list_config_service_resources(
        ...
        # Stored in resqs backend with the arn like "arn:aws:iam::123456789012:policy/my-development-policy"
        ...
        # but it's default set be default, and resqs's config doesn't yet support
